...
check(Model.sabBody("k", "history").indexOf("mode=history") !== -1, "sab history mode")
check(Model.sabBody("k", "history").indexOf("archive=1") !== -1, "sab history uses archive")
check(Model.sabBody("k", "history", null, 10).indexOf("limit=10") !== -1, "sab history custom limit")
